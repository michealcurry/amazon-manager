...
import { reqUpdateStudent } from '../../api';
...
const UpdateStudent = (props) => {
  ...
  const onFinish = (value)=>{
      ...
      }),birthday:value.birthday.toDate(),_id:props.student._id}
      reqUpdateStudent(student).then((response)=>{
  ...
  return (
      <Form
          ...
          initialValues={{
              ...
              phone:props.student.phone.map((item)=>{return item.phoneNumber}),
              birthday:moment(props.student.birthday),
              from:props.student.from,
          }}
